...
#ifndef CV_FONT_1_HPP_
#define CV_FONT_1_HPP_
...
fontdatatype Font16x16[][16]=
{
	...
	{0,  0,192, 48,  8, 48,192,  0,  0, 24,  7,  2,  2,  2,  7, 24},  /* A */
	{0,248,136,136,136,136,136,  8,  0, 31, 16, 16, 16, 16, 25, 15},  /* Á */
	{0,248,136,136,136,136,136,112,  0, 31, 16, 16, 16, 16, 25, 15},  /* B */
	{0,248,  8,  8,  8,  8,  8,  8,  0, 31,  0,  0,  0,  0,  0,  0},  /* Ã */
	{0,224, 16,  8,  8,  8,248,  0,112, 31, 16, 16, 16, 16, 31,112},  /* Ä */
	{0,248,136,136,136,136,136,136,  0, 31, 16, 16, 16, 16, 16, 16},  /* Å */
	{0, 24,112,192,248,192,112, 24,  0, 28,  3,  0, 31,  0,  3, 28},  /* Æ */
	{0, 16,  8,136,136,136, 72, 48,  0,  8, 16, 16, 16, 16, 25, 14},  /* Ç */
	{0,248,  0,  0,128, 96, 24,248,  0, 31, 28,  6,  1,  0,  0, 31},  /* È */
	{0,248,  1,  2,130, 97, 24,248,  0, 31, 28,  6,  1,  0,  0, 31},  /* É */
	{0,248,128,192, 32, 16,  8,  0,  0, 31,  0,  0,  3,  6,  8, 16},  /* Ê */
	{0,  0,248,  8,  8,  8,  8,248, 16, 24, 15,  0,  0,  0,  0, 31},  /* Ë */
	{0,248, 24,224,  0,224, 24,248,  0, 31,  0,  0,  1,  0,  0, 31},  /* M */
	{0,248,128,128,128,128,128,248,  0, 31,  0,  0,  0,  0,  0, 31},  /* H */
	{0,224, 16,  8,  8,  8, 16,224,  0,  7,  8, 16, 16, 16,  8,  7},  /* O */
	{0,248,  8,  8,  8,  8,  8,248,  0, 31,  0,  0,  0,  0,  0, 31},  /* Ï */
	{0,248,  8,  8,  8,  8,152,240,  0, 31,  1,  1,  1,  1,  1,  0},  /* P */
	{0,224, 16,  8,  8,  8,  8, 16,  0,  7,  8, 16, 16, 16, 16,  8},  /* C */
	{0,  8,  8,  8,248,  8,  8,  8,  0,  0,  0,  0, 31,  0,  0,  0},  /* T */
	{0,  8, 48,192,  0,128,112,  8,  0,  0, 16, 16, 15,  3,  0,  0},  /* Ó */
	{0,224, 48, 16,248, 16, 48,224,  0,  3, 12,  8, 31,  8, 12,  7},  /* Ô */
	{0,  8, 16, 96,128, 96, 16,  8,  0, 16, 12,  3,  0,  3, 12, 16},  /* X */
	{0,248,  0,  0,  0,  0,248,  0,  0, 31, 16, 16, 16, 16, 31,112},  /* Ö */
	{0,248,  0,  0,  0,  0,  0,248,  0,  0,  1,  1,  1,  1,  1, 31},  /* × */
	{0,248,  0,  0,248,  0,  0,248,  0, 31, 16, 16, 31, 16, 16, 31},  /* Ø */
	{248, 0, 0,248,  0,  0,248,  0, 31, 16, 16, 31, 16, 16, 31,112},  /* Ù */
	{8,  8,248, 64, 64, 64,128,128,  0,  0, 31, 16, 16, 16, 24, 15},  /* Ú */
	{248, 64, 64, 64,128,  0,  0,248, 31, 16, 16, 16,  8, 7, 0, 31},  /* Û */
	{0,248,128,128,128,128,128,  0,  0, 31, 16, 16, 16, 16, 25, 15},  /* Ü */
	{0, 16,136,136,136,136,144,224,  0,  8, 16, 16, 16, 16, 12,  7},  /* Ý */
	{0,248,128,240, 24,  8, 24,240,  0, 31,  0, 15, 24, 16, 24, 15},  /* Þ */
	{0,  0,240,152,  8,  8,  8,248,  0, 16,  8,  7,  1,  1,  1, 31},  /* ß */
	{0,  0, 64, 32, 32, 32,192,  0,  0, 14, 17, 17, 17,  9, 31,  0},  /* à */
	{0,240,120, 40, 36,100,192,  0,  0, 15, 24, 16, 16, 24, 15,  0},  /* á */
	{0,224, 32, 32, 32, 32,192,  0,  0, 31, 17, 17, 17, 17, 14,  0},  /* â */
	{0,  0,224, 32, 32, 32, 32,  0,  0,  0, 31,  0,  0,  0,  0,  0},  /* ã */
	{0,  0,224, 32, 32, 32,224,  0,  0,112, 31, 16, 16, 16, 31,112},  /* ä */
	{0,192, 32, 32, 32, 32,192,  0,  0,  7,  9, 17, 17, 17,  9,  0},  /* å */
	{0, 32,224,128,224,128,224, 32,  0, 24,  6,  3, 31,  3,  6, 24},  /* æ */
	{0, 64, 32, 32, 32, 32,192,  0,  0,  8, 16, 17, 17, 17, 14,  0},  /* ç */
	{0,224,  0,  0,  0,192,224,  0,  0, 31,  8,  6,  1,  0, 31,  0},  /* è */
	{0,224,  0,  0,  0,192,224,  0,  0, 31,  8,  6,  1,  0, 31,  0},  /* é */
	{0,224,  0,128, 64, 32,  0,  0,  0, 31,  1,  1,  6,  8, 16,  0},  /* ê */
	{0,  0,224, 32, 32, 32,224,  0, 16, 16, 15,  0,  0,  0, 31,  0},  /* ë */
	{0,224,192,  0,  0,  0,192,224,  0, 31,  0,  3,  4,  3,  0, 31},  /* ì */
	{0,224,  0,  0,  0,  0,224,  0,  0, 31,  1,  1,  1,  1, 31,  0},  /* í */
	{0,192, 96, 32, 32, 96,192,  0,  0, 15, 24, 16, 16, 24, 15,  0},  /* î */
	{0,224, 32, 32, 32, 32,224,  0,  0, 31,  0,  0,  0,  0, 31,  0},  /* ï */
	{0,224, 64, 32, 32, 96,128,  0,  0,255, 24, 16, 16, 24,  7,  0},  /* ð */
	{0,128, 64, 32, 32, 32, 64,  0,  0,  7,  8, 16, 16, 16,  8,  0},  /* ñ */
	{0,  0, 32, 32,224, 32, 32,  0,  0,  0,  0,  0, 31,  0,  0,  0},  /* ò */
	{0, 32,192,  0,  0,128, 96,  0,  0,  0,129,198, 60,  3,  0,  0},  /* ó */
	{0,192, 96, 32,252, 32, 96,192,  0, 15, 24, 16,255, 16, 24, 15},  /* ô */
	{0, 32, 64,128,128, 64, 32,  0,  0, 16, 12,  3,  3, 12, 16,  0},  /* õ */
	{0,224,  0,  0,  0,  0,224,  0,  0, 31, 16, 16, 16, 16, 31,112},  /* ö */
	{0,224,  0,  0,  0,  0,224,  0,  0,  1,  2,  2,  2,  2, 31,  0},  /* ÷ */
	{0,224,  0,  0,224,  0,  0,224,  0, 31, 16, 16, 31, 16, 16, 31},  /* ø */
	{0,224,  0,  0,224,  0,  0,224,  0, 31, 16, 16, 31, 16, 16,127},  /* ù */
	{32, 32,224,  0,  0,  0,  0,  0,  0,  0, 31, 17, 17, 17, 17,14},  /* ú */
	{0,224,  0,  0,  0,  0,  0,224,  0, 31, 17, 17, 17, 14,  0, 31},  /* û */
	{0,224,  0,  0,  0,  0,  0,  0,  0, 31, 17, 17, 17, 17, 14,  0},  /* ü */
	{0, 64, 32, 32, 32, 64,128,  0,  0,  8, 17, 17, 17,  9,  7,  0},  /* ý */
	{0,224,  0,192, 96, 32, 96,192,  0, 31,  2, 15, 24, 16, 24, 15},  /* þ */
	{0,192, 32, 32, 32,224,  0,  0,  0, 17, 14,  2,  2, 31,  0,  0}   /* ÿ */
};

#endif /* CV_FONT_1_HPP_ */
